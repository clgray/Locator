...
function Calculator() {
	...
	this.regional[''] = { // Default regional settings
		...
		useText: 'Вставить', // Display text for use link
		useStatus: 'Вставить значение в поле ответа', // Status text for use link
		eraseText: 'Очистить', // Display text for erase link
		eraseStatus: 'Очистить значение в поле ответа', // Status text for erase link
		backspaceText: 'BS', // Display text for backspace link
		backspaceStatus: 'Убрать последнюю цифру', // Status text for backspace link
		clearErrorText: 'CE', // Display text for clear error link
		clearErrorStatus: 'Убрать последнее число', // Status text for clear error link
		clearText: 'CA', // Display text for clear link
		clearStatus: 'Перезагрузить калькулятор', // Status text for clear link
